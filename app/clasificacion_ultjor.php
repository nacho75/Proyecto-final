  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <div id="tabla" class="row">
            <div class="col-md-12">
                <table id="Tablaclaultjor" class="table table-striped table-bordered">
                    <a class="btn btn-info" href="clasificacion_total.php" role="button">Ver clasificación total</a>
                    <thead>
                        <th>id</th>
                        <th>Usuario</th>
                        <th>Equipo</th>
    ...
    <script src="scripts/clasificacion_ultjor.js"></script>
    <!-- endbuild -->
